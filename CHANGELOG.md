...
**Tag:** `v1.0.0`  
**Compare:** [https://github.com/Maatify/security-guard/compare/v0.0.0...v1.0.0](https://github.com/Maatify/security-guard/compare/v0.0.0...v1.0.0)  
**Milestone:** [https://github.com/Maatify/security-guard/milestone/1](https://github.com/Maatify/security-guard/milestone/1)
...
* **High-level login-flow logic (Phase 5) including:**

  * Auto-blocking
  * Failure counting
  * Success resets
  * Remaining-block reporting
...
### **High-Level Security Logic (Phase 5)**

* Added `handleAttempt()` unified decision engine
* Automatic blocking after threshold
* Automatic success reset
* Remaining-block reporting
* `SecurityConfig` runtime configuration
* Integrated event emission for all high-level decisions
* Manual/custom event routing via `handleEvent()`
* Introduced `BlockTypeEnum::AUTO`
* First layer enabling analytics in future phases
